...
LLM_PROVIDER = os.getenv("LLM_PROVIDER", "offine")
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "sk-Pz0ejAAF1TE8ef")
OPENAI_BASE_URL = os.getenv("OPENAI_BASE_URL", "https://api.om/")
